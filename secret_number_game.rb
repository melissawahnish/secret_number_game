...
#    script in the command line. DONE
#
# 2. Also, a parameter to your program should be the range of numbers
#    that the Player may guess from. DONE
#
...
#    exit the program and tell them to fix their input. DONE
#
...
#    sure that their guess attempts count does not increase. DONE
#
...
require_relative 'lib/custom_exception_for_number_game.rb'
require_relative 'lib/game_07.rb'
